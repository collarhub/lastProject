					...
					<table id="review_table" style="border: solid 1px black;">
						<tr style="background-color: #cb842e; color: white;">
							...
							<td style="background-color: white; color: black;"><input
								type="text" style="width: 100%" id="title" name="title"></td>
						</tr>
						<tr style="background-color: #cb842e; color: white;">
							<td style="width: 60px;">책제목</td>
							<td style="background-color: white; color: black;">
							ISBN : <input type="text" name="book_id" id="isbnMain" disabled="disabled">
							<input
								type="text" style="width: 85%" id="inputTitle" name="book_title">
								<div role="button"
						...
						<tr style="background-color: #cb842e; color: white;">
							...
							<td style="background-color: white; color: black;"><textarea
									rows="15" cols="80" style="resize: none;" name="content"></textarea></td>
						</tr>
					</table>
					<a href="review.jsp" class="add ui-button ui-button ui-state-default ui-button-text-only" role="button">
