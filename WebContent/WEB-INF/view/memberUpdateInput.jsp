...
<html>
	...
	<body>
		...
		<div id="center">
			<form action="updateInput.do" method="post" style = "color:black">
				<h1>회원정보수정</h1><hr>
				<h3>회원님의 원하는 정보를 수정해주세요.</h3>
				<label>아이디</label> <input type="text" name="member_id" value="${id }" autofocus required > ${error1 }<br>
				<label>비밀번호</label> <input type="password" name="password" required><br>
				<label>닉네임</label><input type="text" name="nickname" required><br>
				<label>이메일</label><input type="text" name="email" placeholder="xxxxxx@gmail.com" required><br>
				<label>생년월일</label><input type="date" name="birth_date" required ><br>
				<label>전화번호</label><input type="text" name="phone" required><br>
				<label>주소</label><input type="text" name="addr" required><br>
				<label>사진</label><input type="file" name="photo" required><br>
				<label>점수</label><input type="text" name="rank" disabled ><br><br>
				
				<input type="submit"  value="수정완료">
				<input type="reset"  value="재입력">${error }
			</form>
		</div>		
...
>>>>>>> branch 'master' of https://github.com/collarhub/lastProject.git
</html>