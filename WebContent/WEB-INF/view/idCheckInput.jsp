...
/* 		function openIdChk(){
		...
		function inputIdChk(){
			document.userInfo.isDuplication.value="idUncheck";
		} */
	</script>
	</head>
	<body>
		...
		<div id="center">
			<form action="idCheck.do" method="post" style = "color:black">
				<h1>아이디 중복체크</h1><hr>
				<h3>회원가입을 위하여 회원님의 아이디를 확인해주세요.</h3><br>
				<label>아이디</label>&nbsp;<input type="text" name="member_id">&nbsp;
				<input type="submit" value="중복확인"><br><br>   ${error } ${error1 }
			</form>
		</div>		
